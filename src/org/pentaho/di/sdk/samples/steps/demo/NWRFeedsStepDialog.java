 ...
 * 
 */
public class NWRFeedsStepDialog extends BaseStepDialog implements StepDialogInterface {
	 ...
	 */
	private static Class<?> PKG = NWRFeedsStepMeta.class; // for i18n purposes

	// this is the object the stores the step's settings
	// the dialog reads the settings from it when opening
	// the dialog writes the settings to it when confirmed 
	private NWRFeedsStepMeta meta;
	 ...
	 */
	public NWRFeedsStepDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
		super(parent, (BaseStepMeta) in, transMeta, sname);
		meta = (NWRFeedsStepMeta) in;
	}
	...
	public String open() {
		...
		wlValName.setText(BaseMessages.getString(PKG, "NWRFeeds.FieldName.Label")); 
		...
		// username - Demo.FieldName.UserName

		Label wlValUserName = new Label(shell, SWT.RIGHT);
		wlValUserName.setText(BaseMessages.getString(PKG, "NWRFeeds.FieldName.UserName")); 
		props.setLook(wlValUserName);
		FormData fdlValUserName = new FormData();
		fdlValUserName.left = new FormAttachment(0, 0);
		fdlValUserName.right = new FormAttachment(middle, -margin);
		fdlValUserName.top = new FormAttachment(wStepname, margin);
		wlValUserName.setLayoutData(fdlValUserName);

		Text wUserName = new Text(shell, SWT.SINGLE | SWT.LEFT | SWT.BORDER);
		props.setLook(wUserName);
		wUserName.addModifyListener(lsMod);
		FormData fdValUserName = new FormData();
		fdValUserName.left = new FormAttachment(middle, 0);
		fdValUserName.right = new FormAttachment(100, 0);
		fdValUserName.top = new FormAttachment(wStepname, margin);
		wUserName.setLayoutData(fdValUserName);		
