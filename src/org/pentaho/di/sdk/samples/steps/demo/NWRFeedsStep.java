...
public class NWRFeedsStep extends BaseStep implements StepInterface {
	 ...
	 */
	public NWRFeedsStep(StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis) {
	...
	public boolean init(StepMetaInterface smi, StepDataInterface sdi) {
		...
		NWRFeedsStepMeta meta = (NWRFeedsStepMeta) smi;
		NWRFeedsStepData data = (NWRFeedsStepData) sdi;
