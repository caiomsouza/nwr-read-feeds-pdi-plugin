...
@Step(	
		...
		name="NWRFeedsStep.Name",
		description = "NWRFeedsStep.TooltipDesc",
		categoryDescription="i18n:org.pentaho.di.trans.step:BaseStep.Category.Transform"
)
public class NWRFeedsStepMeta extends BaseStepMeta implements StepMetaInterface {
	...
	public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
		return new NWRFeedsStepDialog(shell, meta, transMeta, name);
	}
	...
	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp) {
		return new NWRFeedsStep(stepMeta, stepDataInterface, cnr, transMeta, disp);
	}
